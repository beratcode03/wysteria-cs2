...
Sunucunuza yüklemek için `.dll` dosyasını `csgo/addons/counterstrikesharp/plugins/Wysteria.Disguise/` dizinine atın.
...
## Configuration
Eklentinin ayarları `Wysteria.Disguise.json` dosyasına kaydedilir. Modül yüklendiğinde mevcut değilse otomatik olarak default değerlerle oluşturulur. Sunucu çökmelerine karşı hata toleransı mevcuttur.
