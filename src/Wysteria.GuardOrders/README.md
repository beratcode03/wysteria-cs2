...
Sunucunuza yüklemek için `.dll` dosyasını `csgo/addons/counterstrikesharp/plugins/Wysteria.GuardOrders/` dizinine atın.
...
## Configuration
Eklentinin ayarları `Wysteria.GuardOrders.json` dosyasına kaydedilir. Modül yüklendiğinde mevcut değilse otomatik olarak default değerlerle oluşturulur. Sunucu çökmelerine karşı hata toleransı mevcuttur.
