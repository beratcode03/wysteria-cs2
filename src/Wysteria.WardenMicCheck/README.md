...
Sunucunuza yüklemek için `.dll` dosyasını `csgo/addons/counterstrikesharp/plugins/Wysteria.WardenMicCheck/` dizinine atın.
...
## Configuration
Eklentinin ayarları `Wysteria.WardenMicCheck.json` dosyasına kaydedilir. Modül yüklendiğinde mevcut değilse otomatik olarak default değerlerle oluşturulur. Sunucu çökmelerine karşı hata toleransı mevcuttur.
